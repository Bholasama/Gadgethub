...
<h1 class="text-warning font-monospace text-center my-3">SMARTWATCHES</h1>
<?php
include 'connect.php';
$Record = mysqli_query($con,"select * from tblproduct");
 while($row=mysqli_fetch_array($Record)){
    $check_page = $row['PCategory'];
    if($check_page ==='Smartwatch'){
...
<div class='card m-auto' style='width: 18rem;'>
  <img src='../admin/product/$row[Pimage]' class='card-img-top  m-auto' style= 'width:200px; height:250px;' >
